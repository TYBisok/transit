...
inline void HuluRpcRequestMeta::_internal_set_credential_data(const std::string& value) {
  _has_bits_[0] |= 0x00000008u;
  credential_data_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
...
inline void HuluRpcRequestMeta::set_credential_data(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _has_bits_[0] |= 0x00000008u;
  credential_data_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
...
inline void HuluRpcRequestMeta::set_credential_data(const void* value,
    size_t size) {
  _has_bits_[0] |= 0x00000008u;
  credential_data_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
...
inline std::string* HuluRpcRequestMeta::_internal_mutable_credential_data() {
  _has_bits_[0] |= 0x00000008u;
  return credential_data_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
}
