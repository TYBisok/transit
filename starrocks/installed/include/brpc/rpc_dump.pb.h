...
inline void RpcDumpMeta::_internal_set_authentication_data(const std::string& value) {
  _has_bits_[0] |= 0x00000004u;
  authentication_data_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
...
inline void RpcDumpMeta::set_authentication_data(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _has_bits_[0] |= 0x00000004u;
  authentication_data_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
...
inline void RpcDumpMeta::set_authentication_data(const void* value,
    size_t size) {
  _has_bits_[0] |= 0x00000004u;
  authentication_data_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
...
inline std::string* RpcDumpMeta::_internal_mutable_authentication_data() {
  _has_bits_[0] |= 0x00000004u;
  return authentication_data_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
}
...
inline void RpcDumpMeta::_internal_set_nshead(const std::string& value) {
  _has_bits_[0] |= 0x00000010u;
  nshead_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
...
inline void RpcDumpMeta::set_nshead(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _has_bits_[0] |= 0x00000010u;
  nshead_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:brpc.RpcDumpMeta.nshead)
}
inline void RpcDumpMeta::set_nshead(const void* value,
    size_t size) {
  _has_bits_[0] |= 0x00000010u;
  nshead_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:brpc.RpcDumpMeta.nshead)
}
inline std::string* RpcDumpMeta::_internal_mutable_nshead() {
  _has_bits_[0] |= 0x00000010u;
  return nshead_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
}
