...
inline void NsheadMeta::_internal_set_full_method_name(const std::string& value) {
  _has_bits_[0] |= 0x00000001u;
  full_method_name_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
...
inline void NsheadMeta::set_full_method_name(const char* value) {
  ...
  _has_bits_[0] |= 0x00000001u;
  full_method_name_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:brpc.NsheadMeta.full_method_name)
}
inline void NsheadMeta::set_full_method_name(const char* value,
    size_t size) {
  _has_bits_[0] |= 0x00000001u;
  full_method_name_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
...
inline std::string* NsheadMeta::_internal_mutable_full_method_name() {
  _has_bits_[0] |= 0x00000001u;
  return full_method_name_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
}
...
inline void NsheadMeta::_internal_set_user_string(const std::string& value) {
  _has_bits_[0] |= 0x00000002u;
  user_string_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
...
inline void NsheadMeta::set_user_string(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _has_bits_[0] |= 0x00000002u;
  user_string_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:brpc.NsheadMeta.user_string)
}
inline void NsheadMeta::set_user_string(const void* value,
    size_t size) {
  _has_bits_[0] |= 0x00000002u;
  user_string_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
...
inline std::string* NsheadMeta::_internal_mutable_user_string() {
  _has_bits_[0] |= 0x00000002u;
  return user_string_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
}
