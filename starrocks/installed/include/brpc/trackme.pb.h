...
inline void TrackMeRequest::_internal_set_server_addr(const std::string& value) {
  _has_bits_[0] |= 0x00000001u;
  server_addr_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
...
inline void TrackMeRequest::set_server_addr(const char* value) {
  ...
  _has_bits_[0] |= 0x00000001u;
  server_addr_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:brpc.TrackMeRequest.server_addr)
}
inline void TrackMeRequest::set_server_addr(const char* value,
    size_t size) {
  _has_bits_[0] |= 0x00000001u;
  server_addr_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
...
inline std::string* TrackMeRequest::_internal_mutable_server_addr() {
  _has_bits_[0] |= 0x00000001u;
  return server_addr_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
}
